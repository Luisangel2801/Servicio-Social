...
\section{Objetivos generales y específicos}
    ...
    \begin{itemize}
        ...
        \item Facilitar la replicación y escalabilidad del proyecto mediante una documentación técnica detallada y el uso de Docker para el despliegue de servicios.
    \end{itemize}
